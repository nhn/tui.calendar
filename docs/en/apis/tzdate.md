...
Specifies the hour of the TZDate instance date and time as a given numeric value. You can additionally specify minutes, seconds, and milliseconds. Change an existing TZDate instance.TZDate
