...
function hasGoingDuration(uiModel, options) {
  ...
  var _uiModel$model$goingD2 = uiModel.model.goingDuration,
      goingDuration = _uiModel$model$goingD2 === void 0 ? 0 : _uiModel$model$goingD2;
...
function hasComingDuration(uiModel, options) {
  ...
  var _uiModel$model$coming2 = uiModel.model.comingDuration,
      comingDuration = _uiModel$model$coming2 === void 0 ? 0 : _uiModel$model$coming2;
