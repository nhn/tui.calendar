...
| [goingDuration](#goingduration)                           | EventModel            | 주간/일간뷰의 timed 이벤트의 일정 장소까지 이동 시간               |
| [comingDuration](#comingduration)                         | EventModel            | 주간/일간뷰의 timed 이벤트의 복귀 시간                             |
...
| [popupDetailTitle](#popupdetailtitle)                     | EventModel            | 이벤트 상세 팝업에서 이벤트명                                      |
| [popupDetailDate](#popupdetaildate)                       | EventModel            | 이벤트 상세 팝업에서 이벤트의 기간                                 |
| [popupDetailLocation](#popupdetaillocation)               | EventModel            | 이벤트 상세 팝업에서 이벤트의 장소                                 |
| [popupDetailAttendees](#popupdetailattendees)             | EventModel            | 이벤트 상세 팝업에서 이벤트의 참석자                               |
| [popupDetailState](#popupdetailstate)                     | EventModel            | 이벤트 상세 팝업에서 이벤트의 상태                                 |
| [popupDetailRecurrenceRule](#popupdetailrecurrencerule)   | EventModel            | 이벤트 상세 팝업에서 이벤트의 반복 룰                              |
...
`eventModel` 파라미터를 이용해 주간/일간뷰의 timed 이벤트를 커스터마이징할 수 있다. 이동 시간 및 복귀 시간을 제외한 부분이다.
