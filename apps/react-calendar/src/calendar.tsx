import type ToastUICalendar from '@toast-ui/calendar';
...
interface ToastUICalendarConstructor {
  new (...args: ConstructorParameters<typeof ToastUICalendar>): ToastUICalendar;
}
...
export function createComponent(CalendarConstructor: ToastUICalendarConstructor) {
  return class Calendar extends React.Component<Props> {
    ...
    componentDidMount() {
      ...
      if (container) {
        this.calendarInstance = new CalendarConstructor(container, options);
