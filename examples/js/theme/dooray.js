...
var THEME_DOORAY = {
  ...
  // month more view
  'month.moreView.boxShadow': '0 16px 16px 4px rgba(0, 0, 0, 0.06);',
  'month.moreView.paddingBottom': '0',
  'month.moreViewTitle.height': '52px',
  'month.moreViewTitle.marginBottom': '0',
  'month.moreViewTitle.backgroundColor': '#ffffff',
  'month.moreViewTitle.borderBottom': '1px solid #ddd',
  'month.moreViewTitle.padding': '0 20px',
  'month.moreViewList.padding': '16px 20px 20px 20px',
  ...
  'week.timegridLeftTimezoneLabel.height': '36px',
